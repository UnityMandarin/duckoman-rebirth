...
export const gameConfig: Phaser.Types.Core.GameConfig = {
  ...
  scale: { mode: Phaser.Scale.FIT, autoCenter: Phaser.Scale.CENTER_BOTH, width: TUNING.simulation.width, height: TUNING.simulation.height }, scene: [Gate1Scene,JailScene]
};
